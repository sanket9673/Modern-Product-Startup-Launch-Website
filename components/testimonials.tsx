...
const testimonials = [
  {
    ...
    company: "Disney",
    content:
      "As a first-time founder, I needed a platform that could guide me through the startup process. This product launch platform has been invaluable, helping me validate my idea, build an MVP, and attract our first users in record time.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Samsung",
    content:
      "I've tried several startup platforms, but this one is by far the best. It provided all the tools we needed to launch our SaaS product, from market research to user acquisition strategies that actually work!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "Rio",
    content:
      "Product development used to be a bottleneck in our startup journey, but not anymore. This platform streamlined our launch process and helped us get to market faster. It's like having an experienced co-founder guiding you! Definitely recommend.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "The quality of the tools provided by this platform is outstanding. It has taken our startup from idea to successful launch in just months, allowing us to focus on building our product rather than figuring out the launch process. Highly recommended for any founder.",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "This startup launch platform has been a lifesaver for our tech company. We were able to validate our idea, build our MVP, and acquire our first paying customers in half the time we expected. It's an invaluable asset to any founding team.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "I'm amazed at how well this startup platform performs. It's incredibly versatile and provides tools for every stage of the launch process from market validation to user acquisition and growth strategies. It's fantastic for new founders!",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "I was blown away by how easy it was to launch my startup using this platform! Within a few weeks, I had a professional product in the market with real users, and my investors were impressed by our rapid progress.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "I've never been a fan of complicated startup methodologies, which is why this platform is perfect for me. Its step-by-step approach and intuitive tools made the entire launch process feel manageable and achievable.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "I've never been one for technical details, so finding a startup platform that simplifies the launch process was a dream come true. This platform exceeded my expectations, and I'm proud of how quickly we were able to bring our product to market.",
    categories: [1, 2],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            We've helped hundreds of startups go from idea to successful launch. Our platform provides everything founders need to validate, build, and grow their products in today's competitive market.
          </p>
        </div>
